...
#display weekly results menu
def weeklyResultsMenuFunc(gameState, win, basicFont, backgroundimg, buttonimg, button2img):

    print('in weekly results menu - ', gameState)

    #Create Strings
    title = basicFont.render('Week X Results', False, (255, 255, 255))
    ...
    #Menu Loop
    while gameState[1] == 'weeklyResults':
