...
def gamePreviewMenuFunc(gameState, win, basicFont, backgroundimg, buttonimg, button2img, teamLogos, teamNames, keyBoardKeys):
    ...
    intWeek = int(saveGame.getWeek(gameState))
    ...
    #get current save data from cache for team class object
    playerTeamObjectSaveDataOld = playersTeamObject.getCacheString()
    #get the playoff seed for the players team
    playersTeamSeed = playersTeamObject.getPlayoffSeed()

    if ((opposingTeamName != "None") and (opposingTeamName != "tbd")): #Don't get opposing team data if it is the player teams bye week
        #get team objects from name strings
    ...
    if ((opposingTeamName == "None") or (opposingTeamName == "tbd")):
        #get playernames
        p1L = playersTeamObject.getP1()
        p1LName = p1L.getName()
        p2L = playersTeamObject.getP2()
        ...
        if intWeek <= 21:
            opposingTeamName = "Bye Week"
        elif playersTeamSeed < 13:
            opposingTeamName = "Bye Week"
        else:
            opposingTeamName = "Eliminated From Playoffs"
    ...
    if (int(currentWeek) <= 21):
        subTitle = basicFont.render('Week ' + currentWeek, False, (255, 255, 255))
    elif (int(currentWeek) == 22):
        subTitle = basicFont.render('Eigth Finals Game 1', False, (255, 255, 255))
    elif (int(currentWeek) == 23):
        subTitle = basicFont.render('Eigth Finals Game 2', False, (255, 255, 255))
    elif (int(currentWeek) == 24):
        subTitle = basicFont.render('Eigth Finals Game 3', False, (255, 255, 255))
    ...
    wlRecordLeft = basicFont.render('W/L%:', False, (255, 255, 255))
    wlRecordRight = basicFont.render('W/L%:', False, (255, 255, 255))

    if ((opposingTeamName != "Bye Week") and (opposingTeamName != "Eliminated From Playoffs")): #Set variables if not a bye week
    ...
    #Create these variables if bye
    if ((opposingTeamName == "Bye Week") or (opposingTeamName == "Eliminated From Playoffs")):
    ...
    while gameState[1] == 'gamePreview':
        for event in pygame.event.get():
            ...
            if ((opposingTeamName != "Bye Week") and (opposingTeamName != "Eliminated From Playoffs")): #If not a bye week create all the dynamic variables and strings
                #Draw Shapes
            ...
            #Draw these strings and images if bye week
            if ((opposingTeamName == "Bye Week") or (opposingTeamName == "Eliminated From Playoffs")):
                #Draw Strings
                win.blit(title, (530,50))
                win.blit(subTitle, (550,100))
            ...
            if ((opposingTeamName != "Bye Week") and (opposingTeamName != "Eliminated From Playoffs")): #Dont draw these buttons if bye week
            ...
            if ((opposingTeamName != "Bye Week") and (opposingTeamName != "Eliminated From Playoffs")): #Dont check these buttons if bye week
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if leftTeamScore != rightTeamScore:
                        ...
                        if btn1Hov == True:
                            ...
                            #Simulate and save all other match results for the current week
                            simulationFunctions.simulateWeek(gameState)
                            #Update the timeline
                            simulationFunctions.updateTimeline(gameState)

                            #Go to next menu screen to view results of the current weeks simulated games
            ...
            #Check these button clicks if it is a bye week
            if ((opposingTeamName == "Bye Week") or (opposingTeamName == "Eliminated From Playoffs")):
                if event.type == pygame.MOUSEBUTTONDOWN:
                    print("mouse click")
                    if btn1Hov == True:
                        ...
                        gameState = updateStats.updateStatsPlayer(gameState, p3LName, goalsL3, assistsL3, savesL3, shotsL3)
                        #update team stats in cache
                        gameState = updateStats.updateStatsTeam(gameState, playersTeamName, p1L, p2L, p3L, '2-')
